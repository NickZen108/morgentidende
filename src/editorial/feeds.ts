...
export const EDITORIAL_FEEDS: readonly EditorialFeed[] = [
  ...
  f("ecdc-news", "ECDC – Nyheder og pressemeddelelser", "https://www.ecdc.europa.eu/en/taxonomy/term/1307/feed", "primary", ["liv", "viden", "udland"], ["eu", "sundhed", "smitsomme sygdomme", "udbrud", "epidemiologi", "pressemeddelelser"], { language: "en", country: "EU", authorityWeight: 1 }),
