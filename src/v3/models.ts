import {z} from 'zod';
import {budgetedAI,type CostContext} from './budget';
...
export async function model<T>(env:ModelEnv,role:'chief'|'desk'|'journalist',instructions:string,input:unknown,schema:z.ZodType<T>,search=false,stage:string=role,cost?:CostContext):Promise<T>{
